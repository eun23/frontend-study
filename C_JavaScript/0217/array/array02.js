...
let numbers1 = [1, 2, 3];
let numbers2 = [4, 5, 6];
let mergerdArray = [...numbers1, ...numbers2];
let mergerReverse = [...numbers2, ...numbers1];
console.log(mergerdArray); // [ 1, 2, 3, 4, 5, 6 ]
console.log(mergerReverse); // [ 4, 5, 6, 1, 2, 3 ]
...
//? 다차원 배열에 접근
// : 인덱스를 연속적으로 사용
// : matrix 배열의 첫 번재 행의 두 번째 요소에 접근
let item = matrix[0][1];
console.log(item); // 2