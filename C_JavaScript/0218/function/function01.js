...
// : 데이터(각 요소) 사이에는 ', '
// let cars = ['audi', 'bmw', 'hyundai', 'volvo'];
let combinedCarName = cars.reduce((accumulator, currentValue) =>
