...
// : 위의 값을 제외하고는 모두 true의 값을 반환하기 때문에
...
// case 값의 경우 조건식의 데이터와 같은 데이터타입을 가져야 함
switch (fruit) {
  case "apple":
    console.log("사과");
    break;
...
// * 기본 구조
// 조건 ? 표현식1 : 표현식2
// : 주어진 조건을 평가한 후, 그 결과가 true면 표현식 1을
// : , false면 표현식2를 실행
...
let grade = score > 100 || score < 0 ? '존재하지 않는 점수' 
  : score >= 90 ? 'A'
  : score >= 80 ? 'B'
  : score >= 70 ? 'C'
  : '탈락'
